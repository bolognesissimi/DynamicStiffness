...
function [tempstruct,mdls,MI_av,MI_av_dev,MI_lin,MI_lin_R,MI_exp,MI_exp_R] = mechanical_impedence(sng, N,fs,filtro_intensita, lim_Fmax)
A={};
...
MI_lin_R = zeros(1,N);
MI_exp_R = zeros(1,N);
%filtro_intensita = 1; %Serve a togliere dal fit misure con Fmax troppo elevata
%lim_Fmax = 1000; %Forza a cui si taglia per il fit
